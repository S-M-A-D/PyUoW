...
class BaseSqlAlchemyRepositoryFactory(BaseRepositoryFactory, ABC):
    def __init__(
        self,
        transaction_manager: SqlAlchemyAsyncTransactionManager,
...
class BaseAsyncSqlAlchemyEntityRepository(
    BaseAsyncEntityRepository[ENTITY_ID, ENTITY_TYPE],
    t.Generic[ENTITY_ID, ENTITY_TYPE, ENTITY_TABLE],
    ABC,
):
    def __init__(
...
class BaseAsyncSqlAlchemyRepositoryFactory(BaseRepositoryFactory, ABC):
    def __init__(
        self,
        transaction_manager: SqlAlchemyAsyncTransactionManager,
        readonly_transaction_manager: SqlAlchemyAsyncReadOnlyTransactionManager,
